...
def unike_bedrifter_per_år_tekst(data: pd.DataFrame) -> str:
    unike_år = data["opprettet_year"].unique()
...
def create_datastory(preppede_data: {}) -> DataStory:
    ...
    {unike_bedrifter_per_år_tekst(preppede_data["unike_bedrifter_per_år"])}
